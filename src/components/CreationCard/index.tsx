 ...
 ;
  ...
  const CreationCard = ({
    ...
    return (
      ...
      >
        <Image
          style={{ width: scale(70), height: verticalScale(70),borderRadius:scale(5) }}
          source={images.laptop}
          //   resizeMode="contain"
        />
        <View style={{ paddingLeft: scale(10) ,paddingTop:verticalScale(5),justifyContent:"space-between"}}>
